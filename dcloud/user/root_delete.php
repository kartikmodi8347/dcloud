        	...
        	<div class="col-l20">
          		<div class="card d-depth-2 circul-x1 full-on-l full-on-s" style="margin-top: 40px !important; ">
					...
					<div>
						...
						<?php    
						    	echo '<span style="font-size:14px; line-height:28px; margin-left:8px;">Root Folders </span>';
								...
								if(mysqli_num_rows($select_q) > 0)
								{
											...
											{
												$subfolder = mysqli_query($con,"SELECT linked_dir_id FROM dir_tree WHERE dir_id='$dir[dir_id]' ");
												...
												echo '<tr>
														...
														<input type="checkbox" name="dir_ids[]" value="<?php echo $dir['dir_id']; ?>"/>
